...
class Handler extends Controller{
  ...
  //   // public function dashboard(Request $request){
		...
		// $data["total_stock_retail_fh"] = array_sum(array_column($data["witel"], 'retail_stock_fiberhome'));
		// $data["total_stock_retail_hw"] = array_sum(array_column($data["witel"], 'retail_stock_huawei'));
		// $data["total_stock_retail_zte"] = array_sum(array_column($data["witel"], 'retail_stock_zte'));
		// $data["total_stock_retail_alu"] = array_sum(array_column($data["witel"], 'retail_stock_nokia'));

		// $data["total_stock_premium_fh"] = array_sum(array_column($data["witel"], 'premium_stock_fiberhome'));
		// $data["total_stock_premium_hw"] = array_sum(array_column($data["witel"], 'premium_stock_huawei'));
		// $data["total_stock_premium_zte"] = array_sum(array_column($data["witel"], 'premium_stock_zte'));

		// $data["total_gap_stock_retail_fh"] = $data["total_stock_retail_fh"] - $data["total_retail_fh_minimum"];
		// $data["total_gap_stock_retail_hw"] = $data["total_stock_retail_hw"] - $data["total_retail_hw_minimum"];
		// $data["total_gap_stock_retail_zte"] = $data["total_stock_retail_zte"] - $data["total_retail_zte_minimum"];
		// $data["total_gap_stock_retail_alu"] = $data["total_stock_retail_alu"] - $data["total_retail_alu_minimum"];

		// $data["total_gap_stock_premium_fh"] = $data["total_stock_premium_fh"] - $data["total_premium_fh_minimum"];
		// $data["total_gap_stock_premium_hw"] = $data["total_stock_premium_hw"] - $data["total_premium_hw_minimum"];
		// $data["total_gap_stock_premium_zte"] = $data["total_stock_premium_zte"] - $data["total_premium_zte_minimum"];
...
// 	}
	...
	public function uploadPenerimaan(Request $request, $jenis_upload){
		...
		return back()->with('message', "Upload bulk berhasil!");
	}
