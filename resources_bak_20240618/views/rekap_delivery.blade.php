                                            ...
                                            <thead>
                                                ...
                                                @if (session('asal') != 'Nokia')
                                                    <tr class="text-center"
                                                        ...
                                                        <!--<th @if (session('asal') == 'DID' || session('jenis_akun') == 'sda' || session('jenis_akun') == 'treg') colspan="4" @endif>Retail</th>-->
                                                        <!--<th @if (session('asal') == 'DID' || session('jenis_akun') == 'sda' || session('jenis_akun') == 'treg') colspan="3" @endif>Premium</th>-->
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            @if (session('asal') == 'Fiberhome' ||
                                                                ...
                                                                <td class="minColumnWidth"
                                                                    style="min-width:50px; background-color: #77DD77; @if ($d->retail_stock_fiberhome - $d->retail_fh < -($d->retail_fh * 0.75)) background-color : red; color: white; @elseif($d->retail_stock_fiberhome - $d->retail_fh < 0) background-color: yellow; @endif">
                                                            ...
                                                            @if (session('asal') == 'Fiberhome' ||
                                                                    ...
                                                                    session('jenis_akun') == 'treg')
                                                                <td class="minColumnWidth"
                                                                    style="min-width:50px; background-color: #77DD77; @if ($d->premium_stock_fiberhome - $d->premium_fh < -($d->premium_fh * 0.75)) background-color : red; color: white; @elseif($d->premium_stock_fiberhome - $d->premium_fh < 0) background-color: yellow; @endif ">
                                                            ...
                                                            @if (session('asal') == 'Huawei' ||
                                                                    ...
                                                                    session('jenis_akun') == 'treg')
                                                                <td class="minColumnWidth"
                                                                    style="min-width:50px; background-color: #77DD77; @if ($d->premium_stock_huawei - $d->premium_hw < -($d->premium_hw * 0.75)) background-color : red; color: white; @elseif($d->premium_stock_huawei - $d->premium_hw < 0) background-color: yellow; @endif ">
                                                            ...
                                                            @if (session('asal') == 'ZTE' ||
                                                                    ...
                                                                    session('jenis_akun') == 'treg')
                                                                <td class="minColumnWidth"
                                                                    style="min-width:50px; background-color: #77DD77; @if ($d->premium_stock_zte - $d->premium_zte < -($d->premium_zte * 0.75)) background-color : red; color: white; @elseif($d->premium_stock_zte - $d->premium_zte < 0) background-color: yellow; @endif">
...
<script>
    ...
    function changeTableContent(arr_val) {
        ...
        for (var i = 0; i < arr_val.length; i++) {
            ...
            html += "<td";
            if (obj_val.total_retail_stock - obj_val.total_retail < -(obj_val.total_retail * 0.75)) {
                ...
                html += " style='background-color: #77DD77'";
            }
            html += "> " + (obj_val.total_retail_stock - obj_val.total_retail) + "</td>";


            html += "<td "
            if (obj_val.total_premium_stock - obj_val.total_premium < -(obj_val.total_premium * 0.75)) {
                html += "style='background-color : red; color: white;'";
    ...
    function changeTableDetailContent(arr_val) {
        ...
        for (var i = 0; i < arr_val.length; i++) {
            ...
            if (asalSession == "Fiberhome" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                ...
                if (obj_val.retail_stock_fiberhome - obj_val.retail_fh < -(obj_val.retail_fh * 0.75)) {
            ...
            if (asalSession == "Huawei" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                "treg") {
                html += '<td class="minColumnWidth" style="min-width:50px; background-color: #77DD77;'
                if (obj_val.retail_stock_huawei - obj_val.retail_hw < -(obj_val.retail_hw * 0.75)) {
            ...
            if (asalSession == "ZTE" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                "treg") {
                html += '<td class="minColumnWidth" style="min-width:50px; background-color: #77DD77;'
                if (obj_val.retail_stock_zte - obj_val.retail_zte < -(obj_val.retail_zte * 0.75)) {
                    html += 'background-color : red; color: white;'
            ...
            if (asalSession == "Nokia" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                "treg") {
                html += '<td class="minColumnWidth" style="min-width:50px; background-color: #77DD77;'
                if (obj_val.retail_stock_nokia - obj_val.retail_alu < -(obj_val.retail_alu * 0.75)) {
                    html += 'background-color : red; color: white;'
            ...
            if (asalSession == "Fiberhome" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                "treg") {
                html += '<td class="minColumnWidth" style="min-width:50px; background-color: #77DD77;'
                if (obj_val.premium_stock_fiberhome - obj_val.premium_fh < -(obj_val.premium_fh * 0.75)) {
                    html += 'background-color : red; color: white;'
                } else if (obj_val.total_premium_stock - obj_val.total_premium < 0) {
                    html += 'background-color: yellow;'
                }
            ...
            if (asalSession == "Huawei" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                "treg") {
                html += '<td class="minColumnWidth" style="min-width:50px; background-color: #77DD77;'
                if (obj_val.premium_stock_huawei - obj_val.premium_hw < -(obj_val.premium_hw * 0.75)) {
                    html += 'background-color : red; color: white;'
                } else if (obj_val.total_premium_stock - obj_val.total_premium < 0) {
                    html += 'background-color: yellow;'
                }
            ...
            if (asalSession == "ZTE" || asalSession == "DID" || jenisAkunSession == "sda" || jenisAkunSession ==
                "treg") {
                html += '<td class="minColumnWidth" style="min-width:50px; background-color: #77DD77;'
                if (obj_val.premium_stock_zte - obj_val.premium_zte < -(obj_val.premium_zte * 0.75)) {
                    html += 'background-color : red; color: white;'
                } else if (obj_val.total_premium_stock - obj_val.total_premium < 0) {
                    html += ' background-color: yellow;'
                }
    ...
    @if (session('asal') == 'DID' || session('jenis_akun') == 'sda' || session('jenis_akun') == 'treg')
        $("document").ready(function() {
            ...
            // tableBiasa = $('#filterTable').DataTable();
