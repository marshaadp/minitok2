                    ...
                    <div class="card-body mb-2">
                        <div class="export-filter mb-3">
                            <form id="form_export" action="{{ URL('/export_data_tmp/all') }}" method="POST"
                                ...
                                <div class="col-3">
                                    <button class="btn btn-secondary" value="false" type="submit">Export Data</button>
                                </div>
                                        ...
                                        <table class="table table-bordered" id="filterTable" width="100%">
                                            <thead>
                                                <tr class="text-center"
                                                    ...
                                                    <th hidden>witel</th>
                                                    <th class="minColumnWidth" colspan="1">Total Stock AP</th>
                                                    ...
                                                    <th class="minColumnWidth" colspan="1">Total Minimum Stock
                                                        Requirement AP</th>
                                                    <th class="minColumnWidth" colspan="1">Total On Delivery AP</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php $kebutuhan_stb = 0; ?>
                                                ...
                                                <tr class="text-center"
                                                    ...
                                                    <td value=""
                                                        class="sticky-less-col first-less-col text-center"
                                            ...
                                            <thead>
                                                <tr class="text-center"
                                                    ...
                                                    <th rowspan="2" class="first-col sticky-col"
                                                        ...
                                                        Warehouse</th>
                                                    <th colspan="2">Total Stock AP</th>
                                                    <th colspan="2">GAP Stock</th>
                                                    <th colspan="2">Kebutuhan</th>
                                                    <th colspan="2">Minimum Stock Requirement AP</th>
                                                    <th colspan="2">On Delivery AP</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data['witel'] as $idx => $d)
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="minColumnWidth text-center">{{ $d->stb_zte }}
                                                        </td>
                                                        <td class="minColumnWidth"></td>
