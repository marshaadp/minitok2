                ...
                <div class="card mb-3 mt-3">
                    ...
                    <div class="card-body mb-2">
                        ...
                        <div class="table-responsive">
                            @if (session('asal') == 'DID' || session('jenis_akun') == 'sda')
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="date" class="form-control" name="edit_tanggal_pengiriman"
                                    id="edit_tanggal_pengiriman" required>
                            </div>
                            <div class="col-4">
                                <label>Tanggal Sampai</label>
                                <input type="date" class="form-control" name="edit_tanggal_sampai"
                                    id="edit_tanggal_sampai" required>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-5">
                                <label>Nomor IDO/GD</label>
                                <input type="text" class="form-control" name="edit_ido_gd" id="edit_ido_gd"
                                    style="height: 45px;"
                                    @if (session('asal') != 'DID') placeholder="Diisi oleh DID" readonly @endif>
                            </div>
                            <div class="col-5">
                                ...
                                <input type="file" class="form-control" name="edit_sn_mac_barcode"
                                    ...
                                    @if (session('asal') != 'DID') required @endif
...
<script type="text/javascript">
    ...
    // function save array delete
    /**
     * parameter id row yg dibawa check box
     * push id to array data
     */

    /**
     * function delete data
     * call method delete from controller by endpoint
     */
    ...
    $("document").ready(function() {
        ...
        //         var data = table.rows().data();
        //         var selectedItem = $('#batch-filter').val()
        ...
        @if (session('asal') == 'DID' || session('jenis_akun') == 'sda')
            ...
            // $("#dataTable-pengiriman_filter.dataTables_filter").append($("#categoryLabel"));
        @endif
