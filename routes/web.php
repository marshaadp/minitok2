...
Route::group( ['middleware' => 'adminAuth' ], function(){
	...
	Route::get('/sent_message', "Handler@sentMessage");
	Route::get('/inbox_message', "Handler@inboxMessage");
	Route::get('/history_message', "Handler@historyMessage");

	Route::post('/add_message', "Handler@addMessage");
	Route::get("/get_all_message_with_status_sent", "Handler@getAllMessageWithStatusSent");
	Route::get("/get_all_message_with_status_inbox", "Handler@getAllMessageWithStatusInbox");
	Route::get("/get_all_meesage", "Handler@getAllMessage");
	Route::get("/get_all_notification_message", "Handler@getAllNotificationMessage");
	Route::get("/approve_message/{id}", "Handler@approveMessage");
	Route::get("/reject_message/{id}", "Handler@rejectMessage");
});
